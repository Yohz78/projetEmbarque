...
void createDatabase(const std::string dbName) {
    ...
    std::string sql_string = "CREATE TABLE IF NOT EXISTS sensor_data (date TEXT,temperature REAL,pressure REAL,humidity REAL,x INTEGER,y INTEGER,z INTEGER,mvt INTEGER)";
